...
//	}
	...
	public void addProduct(ProductInfo productInfo, int quantity,int currentQuantity) {
		...
		int newQuantity = line.getQuantity()+quantity<currentQuantity?line.getQuantity()+quantity:currentQuantity;
		if (newQuantity <= 0) {
